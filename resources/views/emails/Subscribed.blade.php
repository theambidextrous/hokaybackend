            	...
            	<tr>
            		<td>
            			<div class="text" style="padding: 0 3em; text-align: center;">
            				...
            				<p>We would like to confirm to you that your <b>{{$period}}</b> job alerts was successfully set. Get ready to receive job updates!</p>
            				<p><a href="{{$jobs}}" class="btn btn-primary">View recent jobs here!</a></p>
            			</div>
            		</td>
            	</tr>
            </table>

    ...
    <div style="max-width: 600px; margin: 0 auto;" class="email-container">
      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
          ...
          <td class="bg_white logo" style="padding: 1em 2.5em; text-align: center">
            <h1><a href="#">HealthcareOkay</a></h1>
          </td>
	      </tr><!-- end tr -->
				<tr>
          <td valign="middle" class="hero" style="background-image: url({{asset('mails/bg_1.jpg')}}); background-size: cover; height: 400px;">
            <table>
            	<tr>
            		<td>
            			<div class="text" style="padding: 0 3em; text-align: center;">
            				<h2>Your Job Post Status</h2>
            				<p>We would like to confirm to you that your job was successfully posted. Get ready to receive applications!</p>
            				<p><a href="{{$edit}}" class="btn btn-primary">Edit your job here!</a></p>
            			</div>
            		</td>
            	</tr>
            </table>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-right: 10px;">
                      	<h3 class="heading">HealthcareOkay</h3>
                      	<p style="color:#ffffff;">Healthcare Okay is the most popular Healthcare jobs board in the world trusted by millions of Healthcare professionals and tens of thousands of Healthcare companies.</p>
                      </td>
                    </tr>
                  </table>
                </td>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-left: 5px; padding-right: 5px;">
                      	...
                      	<ul>
                            <li><span class="text">345 Demo St. Mountain View, San Francisco, CA, USA</span></li>
                            <li><span class="text">hello@healthcareokay.com</span></a></li>
                        </ul>
                      </td>
                    </tr>
                  </table>
